...
module "oidc_provider" {
  source = "github.com/Liviogit/devops_base//td5/scripts/tofu/modules/github-aws-oidc"
...
module "iam_roles" {
  source = "github.com/Liviogit/devops_base//td5/scripts/tofu/modules/gh-actions-iam-roles"
